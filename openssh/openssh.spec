...
Name: openssh
Version: %{openssh_ver}
Release: %{openssh_rel}%{?dist}%{?rescue_rel}.1.tumblr
...
%files ldap
%defattr(-,root,root)
%doc openssh-lpk-openldap.schema openssh-lpk-sun.schema ldap.conf
...
%changelog
* Fri Aug 03 2012 Brent Langston <brent@tumblr.com> 5.8p2-16.1.tumblr
- tumblr-ify this openssh package (brent@tumblr.com)

* Fri Aug 03 2012 Brent Langston <brent@tumblr.com> 5.8p2-16.1
